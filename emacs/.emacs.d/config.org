  ...
  (defun my/text-mode-hook-setup ()
    ...
    (let ((dictionary  "/usr/share/dict/words"))
      (when (file-exists-p dictionary)
          (setq ispell-complete-word-dict dictionary)))
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (setq company-idle-delay 0.1
          ...
          ;; FIXME maybe use a whitelist instead of a blacklist?
          company-global-modes '(not Info-mode
                                     dashboard-mode
                                     xhelp-mode
                                     racer-help-mode
                                     intero-help-mode
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package evil
    ...
    ;; fix tab key in help modes (not that this does NOT bread C-i, at
    ;; least in GUI emacs)
