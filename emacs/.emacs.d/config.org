...
#+BEGIN_SRC emacs-lisp
  (use-package expand-region
    :bind (("C-r" . er/expand-region)
           ("C-S-r" . er/contract-region)
           ("C-M-r" . er/contract-region)))
#+END_SRC
* beacon
#+BEGIN_SRC emacs-lisp
  (use-package beacon
...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra multiple-cursors-hydra (:hint nil
                                    ...
                                    :pre (progn (require 'multiple-cursors)
                                                (setq my/mark-even-if-inactive-backup mark-even-if-inactive)
...
#+BEGIN_SRC emacs-lisp
  (use-package org-bullets
    ...
    :init
    (setq org-src-window-setup 'current-window) ; TODO do I like this behavior?
