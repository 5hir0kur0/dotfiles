...
(defun my/gnome-dark-p ()
  "Return non-nil if GNOME's color-scheme is set to prefer-dark."
  (string-match-p
   "prefer-dark"
   (or (ignore-errors
         (car (process-lines "gsettings" "get"
                             "org.gnome.desktop.interface" "color-scheme")))
       "")))

(defun my/sync-theme-with-gnome ()
  "Load light or dark theme according to GNOME's current setting."
  (interactive)
  (let ((theme (if (my/gnome-dark-p) my/dark-theme my/light-theme)))
    (unless (eq theme doom-theme)
      (setq doom-theme theme)
      (load-theme theme t))))

(my/sync-theme-with-gnome)
#+END_SRC
