...
colors=("--verifcolor=f9f5d7ff" "--wrongcolor=f9f5d7ff" "--timecolor=f9f5d7ee" "--insidecolor=1d202180" \
        ...
        "--insidewrongcolor=fb4934aa" "--datecolor=f9f5d7dd" "--greetercolor=f9f5d7ee")
...
pgrep -x i3lock || i3lock -i /tmp/.screen_locked.png -e --radius=240 --datestr='%F' -k \
    ...
    --greetertext "how about: hindu pushups | pushup & rotation | burpees | jumping jacks | bicycle crunches | mountain climber";
